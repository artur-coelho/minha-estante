<template>
  <div class="light-bg page-container new-book">
    ...
    <div class="new-book__registration-form">
      <book-registration-form @submit="new_book"></book-registration-form>
    </div>
  </div>
</template>
...
import BookRegistrationForm from '@/components/books/BookRegistrationForm.vue';
...
export default {
  ...
  methods: {
    new_book(book) {
      console.log(book)
      axios.post("http://0.0.0.0:8000/livro", book).then(() => {
